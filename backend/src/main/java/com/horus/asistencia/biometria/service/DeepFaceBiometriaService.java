...
public class DeepFaceBiometriaService implements BiometriaService {
    ...
    @org.springframework.beans.factory.annotation.Value("${horus.biometria.umbral:0.68}")
    private double umbralDistancia;

    @org.springframework.beans.factory.annotation.Value("${horus.biometria.modelo:ArcFace}")
