...
public class Empresa {
    ...
    @com.fasterxml.jackson.annotation.JsonIgnore
    @Builder.Default
    private java.util.List<com.horus.asistencia.rrhh.model.Empleado> empleados = new java.util.ArrayList<>();

    @OneToMany(mappedBy = "empresa", cascade = CascadeType.ALL, orphanRemoval = true)
    @com.fasterxml.jackson.annotation.JsonIgnore
    @Builder.Default
    private java.util.List<com.horus.asistencia.identidad.model.Usuario> usuarios = new java.util.ArrayList<>();
    ...
    @com.fasterxml.jackson.annotation.JsonIgnore
    @Builder.Default
    private java.util.List<com.horus.asistencia.marcas.model.MarcacionIntento> intentos = new java.util.ArrayList<>();

    @OneToMany(mappedBy = "empresa", cascade = CascadeType.ALL, orphanRemoval = true)
    @com.fasterxml.jackson.annotation.JsonIgnore
    @Builder.Default
    private java.util.List<com.horus.asistencia.biometria.model.PerfilBiometrico> perfilesBiometricos = new java.util.ArrayList<>();
}
