package com.horus.asistencia.organizacion.controller;
...
public class SedeController {
    ...
    private final com.horus.asistencia.turnos.repository.TurnoPlantillaRepository turnoRepository;
    ...
    public ResponseEntity<Sede> asignarTurnoDefecto(@PathVariable Long id,
            @RequestBody com.horus.asistencia.organizacion.dto.AsignarTurnoSedeDto dto) {
        return sedeRepository.findById(id).map(sede -> {
            if (dto.getTurnoDefectoId() != null) {
                com.horus.asistencia.turnos.model.TurnoPlantilla turno = turnoRepository
