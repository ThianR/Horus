package com.horus.asistencia.licencia;
...
public class LicenciaService {
    ...
    private static final String MASTER_SECRET = "HorusMasterKeyForLicensing2026!VerySecureAndLongString";
    private SecretKey key;
    
    private final String LICENCIA_PATH = "horus.lic"; // Archivo en la raíz del proyecto
    ...
    public void init() {
        ...
        log.info("=== HORUS HARDWARE ID: {} ===", hardwareIdActual);
    ...
    public void validarLicenciaActual() {
        ...
        if (!licFile.exists()) {
            ...
            mensajeError = "No se encontró el archivo de licencia (horus.lic)";
