...
import com.horus.asistencia.rrhh.repository.EmpleadoSedeHabilitadaRepository;
...
public class ImportacionMasivaService {
    ...
    private final com.horus.asistencia.organizacion.repository.EmpresaRepository empresaRepository;

    @Transactional
    public com.horus.asistencia.rrhh.dto.ImportacionResultDto importarEmpleadosYSedes(InputStream inputStream) {
        com.horus.asistencia.rrhh.dto.ImportacionResultDto result = new com.horus.asistencia.rrhh.dto.ImportacionResultDto();
            ...
            for (int i = 1; i <= sheet.getLastRowNum(); i++) {
                ...
                try {
                    ...
                    if (empByCodigo.isPresent()) {
                        ...
                        empleado.setNombreCompleto(nombreCompleto);
                        empleado.setEmail(email.isEmpty() ? codigoEmpleado + "@horus.local" : email);
