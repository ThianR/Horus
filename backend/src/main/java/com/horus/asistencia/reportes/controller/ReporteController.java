...
public class ReporteController {
    ...
    private final com.horus.asistencia.reportes.service.ReporteService reporteService;
    private final com.horus.asistencia.reportes.service.ImportacionService importacionService;
    ...
    private final com.horus.asistencia.rrhh.repository.EmpleadoRepository empleadoRepository;
    ...
    public ResponseEntity<String> seedTestData() {
        ...
        for (int i = 0; i < 5; i++) {
            com.horus.asistencia.marcas.model.MarcacionEvento e = new com.horus.asistencia.marcas.model.MarcacionEvento();
            e.setUuid(java.util.UUID.randomUUID().toString());
            e.setEmpleado(emp);
            e.setTimestampEvento(base.plusDays(i));
            e.setTipoEvento(com.horus.asistencia.marcas.model.MarcacionEvento.TipoEvento.ENTRADA);
            e.setEstadoProceso(com.horus.asistencia.marcas.model.MarcacionEvento.EstadoProceso.PENDIENTE);
            e.setMetodoVerificacion("SEED_TEST");
            marcacionEventoRepository.save(e);

            com.horus.asistencia.marcas.model.MarcacionEvento s = new com.horus.asistencia.marcas.model.MarcacionEvento();
            s.setUuid(java.util.UUID.randomUUID().toString());
            s.setEmpleado(emp);
            s.setTimestampEvento(base.plusDays(i).plusHours(9));
            s.setTipoEvento(com.horus.asistencia.marcas.model.MarcacionEvento.TipoEvento.SALIDA);
            s.setEstadoProceso(com.horus.asistencia.marcas.model.MarcacionEvento.EstadoProceso.PENDIENTE);
