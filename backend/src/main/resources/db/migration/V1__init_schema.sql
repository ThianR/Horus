...
CREATE TABLE IF NOT EXISTS usuario (
    ...
    activo BOOLEAN DEFAULT TRUE,
    empresa_id BIGINT DEFAULT 1 REFERENCES empresa(id),
...
CREATE TABLE IF NOT EXISTS sede (
    ...
    empresa_id BIGINT DEFAULT 1 REFERENCES empresa(id),
    turno_defecto_id BIGINT REFERENCES turno_plantilla(id),
...
CREATE TABLE IF NOT EXISTS asistencia_segmento (
    ...
    turno_segmento_id BIGINT REFERENCES turno_segmento(id),
...
-- 2. Datos por defecto e Iniciales (Idempotentes usando MERGE INTO)

MERGE INTO empresa (id, nombre, identificacion_fiscal, activo) 
KEY(id) 
VALUES (1, 'Empresa Demo/Default', '00000000-0', TRUE);

MERGE INTO usuario (username, password_hash, rol, activo, empresa_id) 
KEY(username) 
VALUES ('admin', '$2a$10$0ht/DM8vJwIH.U0X1R9wd.RkyH0xDj7EcqQ3gHQP7t9YQlauF6qD.', 'ADMIN', TRUE, 1);

MERGE INTO regla_asistencia (nombre, nivel_alcance, tolerancia_entrada, redondeo_entrada, permite_horas_extra) 
KEY(nombre) 
