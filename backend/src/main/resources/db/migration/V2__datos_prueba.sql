...
MERGE INTO sede (nombre, direccion, codigo_externo, version_embeddings) 
KEY(codigo_externo)
VALUES 
...
MERGE INTO empleado (codigo_empleado, numero_documento, nombre_completo, email, estado) 
KEY(codigo_empleado)
VALUES
...
MERGE INTO empleado_sede_habilitada (empleado_id, sede_id, fecha_desde, activo) 
KEY(empleado_id, sede_id, fecha_desde)
VALUES
(1, 1, '2024-01-01', TRUE),
(2, 1, '2024-01-01', TRUE),
(3, 2, '2024-02-01', TRUE),
...
MERGE INTO turno_plantilla (codigo, nombre, tipo_turno, es_nocturno) 
KEY(codigo)
VALUES
...
MERGE INTO turno_segmento (turno_plantilla_id, orden, hora_entrada, hora_salida, tolerancia_tardanza_mins, tolerancia_salida_anticipada_mins) 
KEY(turno_plantilla_id, orden)
VALUES
...
MERGE INTO asignacion_turno (empleado_id, turno_plantilla_id, fecha_inicio) 
KEY(empleado_id, turno_plantilla_id, fecha_inicio)
VALUES
(1, 1, '2024-01-01'),
(2, 1, '2024-01-01'),
(3, 2, '2024-02-01'),
