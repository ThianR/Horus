---
description: cómo compilar y solucionar errores de entorno del backend en oculus
---
# Compilación y Ejecución del Backend Oculus
...
Sin embargo, este proyecto Oculus (Spring Boot 3) **requiere Java 17 o superior**. 
